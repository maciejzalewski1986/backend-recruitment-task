...
class UpgradeData implements UpgradeDataInterface
{
    ...
    public function upgrade(ModuleDataSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        $new_label = "Product label configurable";
        
        $eavSetup->addAttribute(
        		Product::ENTITY,
        		'product_label_configurable',
        		[
        				'group' => 'General',
        				'type' => 'varchar',
        				'label' => $new_label,
        				'input' => 'multiselect',
        				'source' => 'Rectask\ProductStatusAttributeConfigurable\Model\Config\Source\Status',
        				'frontend' => 'Rectask\ProductStatusAttributeConfigurable\Model\Attribute\Frontend\Status',
